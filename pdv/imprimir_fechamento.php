...
<body onload="window.print(); setTimeout(() => { window.location.href = 'about:blank'; }, 500);">
  ...
  <div class="center">
    ...
    <span class="small">CNPJ: 00.000.000/0000-00</span>
  </div>

  <div class="line"></div>

  <div class="center"><b>RESUMO DE FECHAMENTO</b><br>Sessão #<?= $s["id"] ?></div>
  ...
  <div class="row"><span>Total Vendas:</span> <span><?= brl($s["total_geral"]) ?></span></div>
  ...
  <?php foreach($itens as $it): ?>
    <div class="row">
      <span><?= htmlspecialchars(substr($it["nome"], 0, 22)) ?></span>
  ...
  <div class="row"><span>Débito:</span>    <span><?= brl($s["total_cartao_debito"]) ?></span></div>
  <div class="row"><span>Crédito:</span>   <span><?= brl($s["total_cartao_credito"]) ?></span></div>

  <div class="line"></div>

  <div class="center small">Relatório conferido.</div>
