...
<div class="topbar">
  ...
  <nav class="topbar-links">
    ...
    <a href="lucro.php" class="active">📈 Lucro</a>
    <a href="fechamento_caixa.php">🧾 Caixas</a>
  </nav>
</div>
<div class="wrap">
  <div class="page-title">📈 Lucratividade</div>
  <div class="toolbar">
    <div class="t-left">
  ...
  <div class="cards">
    <div class="card">
      ...
      <div class="card-val mono" id="fat" style="color:var(--green);">R$ 0,00</div>
      <div class="card-sub" id="qv">0 vendas</div>
    </div>
    <div class="card">
      <div class="card-label">💸 Custo Compras</div>
      <div class="card-val mono" id="comp" style="color:var(--red);">R$ 0,00</div>
      <div class="card-sub" id="qc">Qtd: 0</div>
    </div>
    <div class="card">
      <div class="card-label">💀 Perdas / Quebras</div>
      <div class="card-val mono" id="perd" style="color:var(--yellow);">R$ 0,00</div>
      <div class="card-sub" id="qp">Qtd: 0</div>
    </div>
    <div class="card">
      <div class="card-label">📈 Lucro Bruto</div>
      <div class="card-val mono" id="luc" style="color:var(--green);">R$ 0,00</div>
      <div class="card-sub" id="marg">Margem: 0%</div>
    </div>
  </div>
</div>
